...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(2, castle_grounds_area_2),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 3937, -394, -13659, 0, 0, 0, (3 << 24), bhvDoor),
		...
		OBJECT(MODEL_NONE, 3943, -394, -13834, 0, 0, 0, (0xD0 << 16), bhvWarp),
	...
	AREA(4, castle_grounds_area_4),
		...
		OBJECT(MODEL_YELLOW_COIN, -1866, 2931, 6520, 0, 0, 0, 0x00000000, bhvOneCoin),
