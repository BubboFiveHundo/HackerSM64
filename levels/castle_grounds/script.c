...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(3, castle_grounds_area_3),
		...
		OBJECT(MODEL_NONE, -7711, 3496, -1630, 0, 0, 0, 0x00000000, bhvLeafParticleSpawner),
		OBJECT(MODEL_NONE, -6829, 12458, -1612, 0, 0, 0, 0x00000000, bhvLeafParticleSpawner),
		OBJECT(MODEL_NONE, -7363, 576, -2014, 0, -3, 0, 0x00000000, bhvGiantPole),
		OBJECT(MODEL_NONE, -6735, 5898, 2899, 0, 177, 0, 0x00000000, bhvGiantPole),
		OBJECT(MODEL_NONE, -7197, 7484, 2315, 0, -5, 0, 0x00000000, bhvGiantPole),
		OBJECT(MODEL_STAR, -6827, 8261, -822, 0, 0, 0, (0x02 << 24), bhvStar),
		OBJECT(MODEL_NONE, -6484, 0, 2608, 0, 0, 0, (0xB0 << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, -6549, 60, 4268, 0, 179, 0, (0xB2 << 16), bhvWarp),
