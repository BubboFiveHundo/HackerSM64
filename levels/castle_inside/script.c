...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(0x0C, LEVEL_CASTLE, 0x01, 0x0D, WARP_CHECKPOINT),
		WARP_NODE(0x0D, LEVEL_CASTLE_GROUNDS, 0x01, 0x0C, WARP_CHECKPOINT),
		MARIO_POS(0x01, 0, 0, 80, 0),
		OBJECT(MODEL_NONE, 0, 80, 0, 0, 0, 0, (0xF1 << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 0, 80, 0, 0, 0, 0, (0xF0 << 16), bhvSpinAirborneWarp),
